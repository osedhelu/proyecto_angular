...
export default (({ angular, ComponetReact }) => {
    let initComponentReact = ({ context, contextRoot }) => {
        validateElementCreation('deoslv_devices_controller', (element) => {
    ...
    angular.module('headwind-kiosk')
        .controller('DevicesTabController', function ($scope, $rootScope, $state, $modal, $interval, $cookies, $window, $filter, $timeout,
            ...
            $scope.init = () => {
                console.log("🚀 ~ file: devices.controller.js:260 ~ init:")
        ...
        .controller('DeviceApplicationSettingsModalController', function ($scope, $modal, $modalInstance,
            ...
            resolve({ hola: "hola mundo" }, (aa) => {
                console.log("🚀 ~ file: devices.controller.js:1357 ~ resolve ~ aa:", aa)
