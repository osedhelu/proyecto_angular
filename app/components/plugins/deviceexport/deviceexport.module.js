...
angular.module('plugin-deviceexport', ['ngResource', 'ui.bootstrap', 'ui.router', 'ngTagsInput', 'ncy-angular-breadcrumb'])
    ...
    .controller('PluginDeviceExportTabController', function ($scope, $rootScope, $window, $location, $interval, $http,
        ...
        $scope.columnsList = [
            ...
            {id: 'serial', label: localization.localize('plugin.deviceexport.column.serial')},
            ...
            {id: 'device.status', label: localization.localize('plugin.deviceexport.column.device.status')},
            ...
            {id: 'publicip', label: localization.localize('plugin.deviceexport.column.publicip')},
            {id: 'mdm.mode', label: localization.localize('plugin.deviceexport.column.mdm.mode')},
            {id: 'kiosk.mode', label: localization.localize('plugin.deviceexport.column.kiosk.mode')},
            {id: 'android.version', label: localization.localize('plugin.deviceexport.column.android.version')}
        ];
