...
export const useLocalization = () => {
    ...
    const [localizationData, setLocalizationData] = useState(ar_AE);
    const { localization } = document
    useEffect(() => {
        if (localization) {
            setLocalizationData(localization[browserLanguage])
        }
    }, [localization]);

    return {
        location: localizationData
    };
};
